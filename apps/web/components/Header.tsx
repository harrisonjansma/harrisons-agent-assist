  ...
  return (
    <header className="animate-rise">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex shrink-0 flex-wrap items-center gap-x-3 gap-y-2 sm:flex-col sm:items-end">
          <div className="flex items-center gap-2.5">
            <a href={SITE_URL} target="_blank" rel="noreferrer" aria-label="Harrison Jansma" className="shrink-0">
              {/* A little face to make it personal */}
              <span className="brand-gradient block rounded-full p-[2.5px] shadow-[0_6px_18px_-6px_rgba(79,70,229,0.55)]">
                <img
                  src="/harrison.png"
                  alt="Harrison Jansma"
                  width={48}
                  height={48}
                  className="block h-12 w-12 rounded-full border-2 border-white object-cover object-[50%_28%]"
                />
              </span>
            </a>
